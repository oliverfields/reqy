...
class TestGlossaryTermDefinition():
	...
	def test_valid_gtd_config(self):
		...
		gtd.load_config_from_file('test_data/term_definition_1.def')
	...
	def test_valid_gtd_config(self):
		gtd = GlossaryTermDefinition()
		gtd.load_config_from_file('test_data/term_definition_2.def')
		assert gtd.definition == 'A round fruit'
		assert gtd.term == 'Apple'
	...
	def test_invalid_gtd_config(self):
		...
		with pytest.raises(SystemExit):
			gtd.load_config_from_file('test_data/invalid_term_definition.def')

	def test_invalid_gtd_config_1(self):
		gtd = GlossaryTermDefinition()
		with pytest.raises(SystemExit):
			gtd.load_config_from_file('test_data/invalid_term_definition_1.def')

	def test_invalid_gtd_config_2(self):
		gtd = GlossaryTermDefinition()
		with pytest.raises(SystemExit):
			gtd.load_config_from_file('test_data/invalid_term_definition_2.def')

	def test_invalid_gtd_config_3(self):
		gtd = GlossaryTermDefinition()
		with pytest.raises(SystemExit):
			gtd.load_config_from_file('test_data/invalid_term_definition_3.def')

	def test_invalid_gtd_config_4(self):
		gtd = GlossaryTermDefinition()
		with pytest.raises(SystemExit):
			gtd.load_config_from_file('test_data/invalid_term_definition_4.def')
